        ...
        <div className="w-[1320px] flex flex-col items-center justify-center gap-10 max-w-full mq750:gap-5">
          ...
          <div className="self-stretch flex flex-row items-center justify-between gap-4 max-w-full">
            ...
            >
              <SwiperSlide>
                <div
                  className="h-[374px] flex-1 flex flex-col items-start justify-start pt-0 px-0 pb-6 box-border gap-4 bg-[url('/1@3x.png')] bg-cover bg-no-repeat bg-[top] cursor-pointer"
                  onClick={() => handleNavigation("/eyeglasses/eyeglasses")}
                >
