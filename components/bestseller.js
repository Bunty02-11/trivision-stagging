    ...
    >
      ...
      <div className="self-stretch flex flex-row items-center justify-between gap-4 max-w-full">
        ...
        >
          <SwiperSlide>
            <div
              className="h-[374px] flex flex-col items-start justify-start pt-0 px-0 pb-6 box-border gap-4 bg-[url('/2@3x.png')] bg-cover bg-no-repeat bg-[top] cursor-pointer"
              onClick={() =>
                handleNavigationToSunglasses("/sunglasses/sunglasses")
              }
            >
