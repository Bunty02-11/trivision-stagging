...
const Ideology = memo(({ className = "" }) => {
  return (
    ...
    >
      <div className=" flex flex-row items-start justify-center max-w-full mq480:gap-[109px] mq750:gap-[219px] mq1280:gap-[437px]">
      ...
      <div className=" flex flex-row items-start justify-center flex-wrap content-start gap-10 max-w-full text-base mq750:gap-5 mq750:grid-cols-[minmax(300px,_1fr)] mq1100:justify-center mq1100:grid-cols-[repeat(2,_minmax(300px,_520px))]">
        <IdeologyBullets
